...
const descriptions  = {
    mercury: {
        short: 'The first planet in our solar system',
        long: {
            title: "Mercury",
            paragraph: [
    ...
    venus: {
        short: 'The second planet in our solar system',
        long: {
            title: "Twin Sister",
            paragraph: [
    ...
    earth: {
        short: 'The third planet in our solar system',
        long: {
            title: "Our home - Earth",
            paragraph: [
    ...
    mars: {
        short: 'The fourth planet in our solar system',
        long: {
            title: "Red Planet",
            paragraph: [
    ...
    jupiter: {
        short: 'The fifth planet in our solar system',
        long: {
    ...
    saturn: {
        short: 'The sixth planet in our solar system',
        long: {
            title: "Saturn",
            paragraph: [
    ...
    uranus: {
        short: 'The seventh planet in our solar system',
        long: {
            title: "Uranus",
            paragraph: [
    ...
    neptune: {
        short: 'The first planet discovered with math',
        long: {
            title: "Big Blue",
            paragraph: [
